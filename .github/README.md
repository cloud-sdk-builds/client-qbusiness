...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.672.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.672.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k9ky1dab8YG61msPLWprVqdA4KhQhROgBPCD9d+g4pSFWQili/C4ymtGDq8Wsp9H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.672.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.672.0/index.min.mjs": "sha384-k9ky1dab8YG61msPLWprVqdA4KhQhROgBPCD9d+g4pSFWQili/C4ymtGDq8Wsp9H"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.672.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.672.0/LICENSE
```
