...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.739.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.739.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HEX7XPW/die2KGo7xnw8eYIGzwfuM3E6M2mAFrygdkPfYIR3AN/GQSaZBrYz7osi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.739.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.739.0/index.min.mjs": "sha384-HEX7XPW/die2KGo7xnw8eYIGzwfuM3E6M2mAFrygdkPfYIR3AN/GQSaZBrYz7osi"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.739.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.739.0/LICENSE
```
