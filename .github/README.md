...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.733.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.733.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DKLra8nNXve6Ey+4YS61I5WSBEsEom3qZSiKM51B2zJyS5YImith5BP5E2d5JE7P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.733.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.733.0/index.min.mjs": "sha384-DKLra8nNXve6Ey+4YS61I5WSBEsEom3qZSiKM51B2zJyS5YImith5BP5E2d5JE7P"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.733.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.733.0/LICENSE
```
