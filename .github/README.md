...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.793.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.793.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xmsosbzzqu6T7AvA5DRVsL2486ZgQnJmtBQhry6AwAKLi1wibL+3kEZ2+LhLNAkc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.793.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.793.0/index.min.mjs": "sha384-Xmsosbzzqu6T7AvA5DRVsL2486ZgQnJmtBQhry6AwAKLi1wibL+3kEZ2+LhLNAkc"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.793.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.793.0/LICENSE
```
