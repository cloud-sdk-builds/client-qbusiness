...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.707.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.707.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZfAVBf2SjVJyK6yjouAR2ZDV4CbMZbF8mN58JqkQezR+s1AUALM8LNp8ofjh9mls
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.707.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.707.0/index.min.mjs": "sha384-ZfAVBf2SjVJyK6yjouAR2ZDV4CbMZbF8mN58JqkQezR+s1AUALM8LNp8ofjh9mls"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.707.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.707.0/LICENSE
```
