...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.760.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.760.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kpf2VRwXeBVgFDtCN5UGYhjnzlH+IMUgySqoz5+0NhBjCra2ch3r0ZPsrJMY6m82
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.760.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.760.0/index.min.mjs": "sha384-kpf2VRwXeBVgFDtCN5UGYhjnzlH+IMUgySqoz5+0NhBjCra2ch3r0ZPsrJMY6m82"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.760.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.760.0/LICENSE
```
