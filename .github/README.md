...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.603.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.603.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Vuvf41qdgU4sVQ0SKz6TaIi3rQ4jsmucJ33XSnXprjijCVrbHlraV+Bdz3HNf2jt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.603.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.603.0/index.min.mjs": "sha384-Vuvf41qdgU4sVQ0SKz6TaIi3rQ4jsmucJ33XSnXprjijCVrbHlraV+Bdz3HNf2jt"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.603.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.603.0/LICENSE
```
