...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.605.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.605.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LFKWSLcJCAkPa0e3d5Rycod3Nu5+xVai7cBOQzJVfQO5jH42sCXZP4qIlQspoG6h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.605.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.605.0/index.min.mjs": "sha384-LFKWSLcJCAkPa0e3d5Rycod3Nu5+xVai7cBOQzJVfQO5jH42sCXZP4qIlQspoG6h"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.605.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.605.0/LICENSE
```
