...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.705.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.705.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IfTVnwumhu9AjJB8cCg5y2gAhavL3ZftEL6H3j7IcHY8LwE1q52jtrEnaRWSNFCt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.705.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.705.0/index.min.mjs": "sha384-IfTVnwumhu9AjJB8cCg5y2gAhavL3ZftEL6H3j7IcHY8LwE1q52jtrEnaRWSNFCt"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.705.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.705.0/LICENSE
```
