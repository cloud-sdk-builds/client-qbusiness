...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.566.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.566.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6csF4/+jxA6rV28QAZ97XP6tWxdMOZDQ43dCFFD7H38jOQEKInhH6arA4oeojd/w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.566.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.566.0/index.min.mjs": "sha384-6csF4/+jxA6rV28QAZ97XP6tWxdMOZDQ43dCFFD7H38jOQEKInhH6arA4oeojd/w"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.566.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.566.0/LICENSE
```
