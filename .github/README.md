...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.703.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.703.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Nwg9UY4bDYmNJ/mO2NvtlCp7+BdzItfC+p8wh2yywgpvKM/S+g90gjVNL2KtQik5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.703.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.703.0/index.min.mjs": "sha384-Nwg9UY4bDYmNJ/mO2NvtlCp7+BdzItfC+p8wh2yywgpvKM/S+g90gjVNL2KtQik5"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.703.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.703.0/LICENSE
```
