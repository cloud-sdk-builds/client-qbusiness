...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.742.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.742.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4XWs1gG7gS0tgSy2s7ZyupPTbAJBcjI+dpgcTpRuYu+Oz/sa9KUweLjVxBmoGNaY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.742.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.742.0/index.min.mjs": "sha384-4XWs1gG7gS0tgSy2s7ZyupPTbAJBcjI+dpgcTpRuYu+Oz/sa9KUweLjVxBmoGNaY"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.742.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.742.0/LICENSE
```
