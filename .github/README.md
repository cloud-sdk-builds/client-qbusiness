...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.838.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.838.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sE7sYzHMtvmqVW9yS0nr/W3O5oGeY8hyFHRScVVLCx8LvNNq7K+DRYF18cYWwqhw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.838.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.838.0/index.min.mjs": "sha384-sE7sYzHMtvmqVW9yS0nr/W3O5oGeY8hyFHRScVVLCx8LvNNq7K+DRYF18cYWwqhw"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.838.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.838.0/LICENSE
```
