...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.557.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.557.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-loGSBEPoqppHeCYENMgjJIsO7yStugQMJDwgNAr0/kix5xFx6Ez719Vu2eg6nCn4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.557.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.557.0/index.min.mjs": "sha384-loGSBEPoqppHeCYENMgjJIsO7yStugQMJDwgNAr0/kix5xFx6Ez719Vu2eg6nCn4"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.557.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.557.0/LICENSE
```
