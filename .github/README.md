...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.638.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.638.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KS0UE/33phh2DmDvcjekdxpa3uKffODR/I99RmPBOHTNcvcuF8UeL6imq7xGgZYc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.638.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.638.0/index.min.mjs": "sha384-KS0UE/33phh2DmDvcjekdxpa3uKffODR/I99RmPBOHTNcvcuF8UeL6imq7xGgZYc"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.638.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.638.0/LICENSE
```
