...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.841.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.841.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+Oy21NmFLj3NAL1WBcshBBWyaEiEzcl6JxhPoU24s+lDiRbOsbDRL4WfpqSbS0Ih
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.841.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.841.0/index.min.mjs": "sha384-+Oy21NmFLj3NAL1WBcshBBWyaEiEzcl6JxhPoU24s+lDiRbOsbDRL4WfpqSbS0Ih"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.841.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.841.0/LICENSE
```
