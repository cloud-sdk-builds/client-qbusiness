...
[`@aws-sdk/client-qbusiness`](https://www.npmjs.com/package/@aws-sdk/client-qbusiness/v/3.751.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.751.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZD4D4TiTxQ82rzp4GzAYbYh4P3pvYQ/sCZ1/NWkfEtvMXC7G+MK/GNmwvstuSdEg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-qbusiness": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.751.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-qbusiness@3.751.0/index.min.mjs": "sha384-ZD4D4TiTxQ82rzp4GzAYbYh4P3pvYQ/sCZ1/NWkfEtvMXC7G+MK/GNmwvstuSdEg"
        }
      }
</script>
```
...
* Always pin to a specific version (`@3.751.0`)
...
```
https://github.com/cloud-sdk-builds/client-qbusiness/blob/refs/tags/3.751.0/LICENSE
```
